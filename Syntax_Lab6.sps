...
save results /outfile= 'C:\Users\gi7113ha\OneDrive - Lund University\PhD Courses\Quantitative Methods – Multivariate Analysis\Week4\Lab6_FactorAnalysis\screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'C:\Users\gi7113ha\OneDrive - Lund University\PhD Courses\Quantitative Methods – Multivariate Analysis\Week4\Lab6_FactorAnalysis\screedata.sav'.
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 
    ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 
    ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT BLANK(.20)
  /PLOT EIGEN
...
FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar21 ar23 
    ar24 ar25 ar26 ar27 ar28 ar8
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar21 ar23 
    ar24 ar25 ar26 ar27 ar28 ar8
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT BLANK(.20)
  /PLOT EIGEN
...
COMPUTE animal_food=MEAN(ar5,ar13,ar4,ar23,ar26,ar10).
EXECUTE.



COMPUTE animal_research=MEAN(ar6,ar27,ar2,ar12,ar15,ar20,ar9,(6 - ar21),ar17,ar25,(6 - 
    ar19),ar18,ar11,ar14).
EXECUTE.

COMPUTE animal_killing=MEAN(ar24,(6 - ar7),ar28).
EXECUTE.
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER animal_food animal_research animal_killing.
